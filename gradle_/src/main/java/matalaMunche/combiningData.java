...
public class combiningData {
	 ...
	 */
	public static boolean toCSV(String folderPath, String CSVpath) {
		LinkedList<Wifi> listofWifi=list(folderPath);
	...
	/**
	 * This method creates Linked List which contains the legit's Wifi points 
	 * This method was created in order to test the output of the function "fileToList"
	 * @param folderPath path of the folder with the data of the application "wiGLE"
	 * @return Linked List which contains the legit's Wifi points 
	 */
	
	public static LinkedList <Wifi> list(String folderPath){
	 ...
	 * 
	 */
	private static String getFileFormat(File f) {
	...
	private static LinkedList<Wifi> fileToList(File[] listOfFiles){
	 ...
	 * 
	 */
	private static boolean legit(String str){
	...
	public static boolean listToCsv (LinkedList<Wifi> wifis, String CSVpath) {
		return listToCSV( wifis, CSVpath);
	}
	
	private static boolean listToCSV(LinkedList<Wifi> wifis, String CSVpath) {
